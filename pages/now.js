...
export default function Now(currentlyReading) {
  ...
  var YashviBirthDate = '2004-07-28'
  var birthDate = new Date(YashviBirthDate)

  var YashviAge = year - birthDate.getFullYear()

  var YashviMonth = 0
  if (month >= birthDate.getMonth()) YashviMonth = month - birthDate.getMonth()
  else {
    YashviAge--
    YashviMonth = 12 + month - birthDate.getMonth()
  }

  var YashviDay = 0
  if (date >= birthDate.getDate()) YashviDay = date - birthDate.getDate()
  else {
    YashviMonth--
    YashviDay = 31 + date - birthDate.getDate()
    if (YashviMonth < 0) {
      YashviMonth = 11
      YashviAge--
    }
      ...
      <div>
        ...
        <div className="pb-4">
          <p>
            ...
            . */}
            I am currently working on a project based on Deep Learning and Edge Computing.
          </p>
          <br />
          <p>
            I am also preparing for roles in Data Science and AI, focusing on strengthening my
            Python skills and understanding of machine learning.
          </p>
          <br />
          <p>
        ...
        <div className="pt-6">
          ...
          <br />
          <p>
            I’m planning to apply for a Master’s in Data Science or AI in the next couple of years.
            I haven’t decided on the university yet, but I’ll update this page once I do.
          </p>
          <br />
          <p>
            I recently started drafting a blog post about YOLOv8 real-time object detection, it will
            be live soon!
          </p>
        </div>
